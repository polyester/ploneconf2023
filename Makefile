...
build-acceptance-servers: ## Build Acceptance Servers
	...
	@docker build backend -t polyester/ploneconf2023-backend:acceptance -f backend/Dockerfile.acceptance
	@echo "Build acceptance frontend"
	@docker build frontend -t polyester/ploneconf2023-frontend:acceptance -f frontend/Dockerfile
