...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2023-polyester.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=ploneconf2023-polyester-tangrama-com-br
```
...
prod:
  hosts:
    ploneconf2023-polyester.tangrama.com.br:
      ansible_user: root
      host: ploneconf2023-polyester
      hostname: ploneconf2023-polyester.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2023-polyester.tangrama.com.br.yml` to the remote server with:
